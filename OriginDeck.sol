...
contract OriginDeck is ERC721, ERC721Enumerable, ERC2981ContractWideRoyalties, Ownable {

    using Strings for uint256;

    string public PROVENANCE;
    uint256 public constant tokenPriceforPresale = 3000000000000000; // 0.3 ETH
    uint256 public tokenPrice = 3000000000000000; // 0.3 ETH
    ...
    function setLimitPerWallet(uint256 limitAmount) public onlyOwner() {
        limitPerWallet = limitAmount;
    }
    ...
    function mintToken() public payable {
        ...
        uint curPrice = tokenPrice * 1001;
        tokenPrice = curPrice / 1000;
    }
